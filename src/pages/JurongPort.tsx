...
export function JurongPort() {
  return (
    <>
      <section className="relative h-[400px] overflow-hidden group">
        <div className="absolute inset-0 bg-[url('/jurong-header.jpg')] bg-cover bg-center transition-transform duration-700 group-hover:scale-110"></div>
        <div className="absolute inset-0 bg-[#1e4a66] bg-opacity-70"></div>
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl font-bold mb-6 animate-fade-in-down">Jurong Port</h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <AnimatedSection direction="left">
              <div className="relative">
                <div className="rounded-full overflow-hidden w-full max-w-md mx-auto aspect-square shadow-2xl">
                  <img
                    src="/jurong-terminal.png"
                    alt="Jurong Port Storage Facility"
            ...
            <AnimatedSection direction="right">
              <h2 className="text-4xl font-bold text-[#1e4a66] mb-6">Jurong Port</h2>
              <div className="space-y-4 text-gray-700 leading-relaxed text-justify">
                <p>
                  Are you prepared to impact Singapore's energy transition? Find out how Bover Shipping B.V can accompany you on this adventure. Contact us right now to find out why we are the perfect energy transition partner.
                </p>
                <p>
                  An integrated hybrid storage terminal for gas, chemicals, and oil is called Bover Shipping B.V. Furthermore, Bover Shipping B.V manages an approximately 80,000 cbm liquefied petroleum gas (LPG) plant at this terminal through a partnership called Bover Shipping B.V Gas Terminal. Additional services include pipe connectivity delivery to plants, re-gasification, and VLGC (Very Large Gas Carrier) discharge; future availability of pressurized and/or refrigerated shipments to supplement local and regional supply.
                </p>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <AnimatedSection direction="up" delay={100}>
              <div className="text-center">
                ...
                <div className="text-3xl font-bold mb-2">
                  <CountUpNumber end={145216} duration={2000} /> cbm
                </div>
            ...
            <AnimatedSection direction="up" delay={200}>
              <div className="text-center">
                ...
                <div className="text-3xl font-bold mb-2">
                  <CountUpNumber end={112} duration={2000} />
                </div>
              ...
              <div className="bg-white p-6 shadow-md">
                ...
                <div className="space-y-4 px-4">
                  <div className="relative h-[400px] rounded-lg overflow-hidden shadow-lg">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15955.2!2d103.6983!3d1.3048!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMcKwMTgnMTcuMyJOIDEwM8KwNDEnNTMuOSJF!5e0!3m2!1sen!2ssg!4v1234567890"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen
                  ...
                  <a
                    href="https://maps.google.com/?q=Jurong+Island,+Singapore"
                    target="_blank"
