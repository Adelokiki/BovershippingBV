...
export function PortOfRotterdam() {
  return (
    <>
      <section className="relative h-[400px] overflow-hidden group">
        <div className="absolute inset-0 bg-[url('/image%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy%20copy.png')] bg-cover bg-center transition-transform duration-700 group-hover:scale-110"></div>
        <div className="absolute inset-0 bg-[#1e4a66] bg-opacity-70"></div>
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl font-bold mb-6 animate-fade-in-down">Port of Rotterdam</h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <AnimatedSection direction="left">
              <div className="relative">
                <div className="rounded-full overflow-hidden w-full max-w-md mx-auto aspect-square shadow-2xl">
                  <img
                    src="/image copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy copy.png"
                    alt="Port of Rotterdam Storage Tanks"
            ...
            <AnimatedSection direction="right">
              <h2 className="text-4xl font-bold text-[#1e4a66] mb-6">Port Of Rotterdam</h2>
              <div className="space-y-4 text-gray-700 leading-relaxed text-justify">
                <p>
                  For liquid bulk energy products, Bover Shipping B.V is the top independent provider of handling and storage services in North Western Europe. Supporting vital energy supply chains is how we contribute to society in this role.
                </p>
                <p>
                  Through our terminals located around the Netherlands, we provide our clients excellent services. Our mission is to prioritize profit, the environment, and people while leading our industry in sustainability and safety. Safety is our first priority, and we're constantly searching for methods to reduce the environmental impact of our terminals. We continue to reinvest in our assets and generate substantial financial returns for Bover Shipping B.V.
                </p>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <AnimatedSection direction="up" delay={100}>
              <div className="text-center">
                ...
                <div className="text-3xl font-bold mb-2">
                  <CountUpNumber end={385381} duration={2000} /> cbm
                </div>
            ...
            <AnimatedSection direction="up" delay={200}>
              <div className="text-center">
                ...
                <div className="text-3xl font-bold mb-2">
                  <CountUpNumber end={99} duration={2000} />
                </div>
            ...
            <AnimatedSection direction="up" delay={300}>
              <div className="text-center">
                ...
                <div className="text-3xl font-bold mb-2">
                  <CountUpNumber end={21} duration={2000} />
                </div>
              ...
              <div className="bg-white p-6 shadow-md">
                ...
                <div className="space-y-4 px-4">
                  <div className="relative h-[400px] rounded-lg overflow-hidden shadow-lg">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39194.8!2d4.4777!3d51.9225!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c5b7605197f097%3A0xd5d662ab2e5c2db!2sPort%20of%20Rotterdam!5e0!3m2!1sen!2snl!4v1234567890"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen
                  ...
                  <a
                    href="https://maps.google.com/?q=Port+of+Rotterdam,+Netherlands"
                    target="_blank"
